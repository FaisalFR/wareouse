...
?>
	<div class="col-md-6">
		<div class="panel panel-default">
			...
			<?php 
				...
				$brg = $barang->ambil_barang($_GET['keluar']);
	...
	<div class="col-md-12">
		...
		<a href="index.php?page=detailbarang2" class="btn btn-warning"><i class="fa fa-arrow-right"></i> Back</a>
		</div>				
	</form><!--End Form-->
	</div>
	<?php 
	...
	if (isset($_POST['save'])) {
		$penjualan->simpan_pengambilan($_POST['kdinput'],$kdbarang, $_POST['tglinput'],$_POST['jumlah']);
		echo "<script>location='index.php?page=detailbarang2';</script>";
	}
