  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">PT.TT METALS INDONESIA</a> 
      </div>
        ...
        <ul class="nav" id="main-menu">
          <li class="text-center">
            <img src="gambar_admin/<?php echo $_SESSION['login_admin']['gambar']; ?>" class="user-image img-circle img-responsive"/>
				...
				<li>
            <a  href="index.php?page=barang"><i class="fa fa-qrcode"></i>Master Data Barang<span class="fa arrow"></span></a>
			<ul class="nav nav-second-level">
              <li>
                <a  href="index.php?page=barang"><i class="fa fa-database"></i> Data Barang</a>
              </li>
              <li>
                <a  href="index.php?page=tambahbarang"><i class="fa fa-plus-square"></i> Input Data Barang</a>
              </li>
            </ul>
          </li>
          <li>
            <a  href="#"><i class="fa fa-money"></i>Penerimaan Barang<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
                <a  href="index.php?page=pembelian"><i class="fa fa-database"></i> Data Penerimaan</a>
              </li>
              <li>
                <a  href="index.php?page=detailbarang"><i class="fa fa-plus-square"></i> Input Data Penerimaan</a>
              </li>
            </ul>
          </li>
          <li>
            <a  href="#"><i class="fa fa-money"></i>Pengambilan Barang<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
                <a  href="index.php?page=penjualan"><i class="fa fa-database"></i> Data Pengambilan</a>
              </li>
              <li>
                <a  href="index.php?page=detailbarang2"><i class="fa fa-plus-square"></i> Input Data Pengambilan</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            <a  href="#"><i class="fa fa-wrench"></i> Kelola Admin<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
                <a  href="index.php?page=admin"><i class="fa fa-user"></i> Data Admin</a>
              </li>
            </ul>
          </li>
      </div>      
      ...
      <div id="page-inner">
        <?php  
          if (isset($_GET['page'])) {
			...
			elseif ($_GET['page']=="ubahminta") {
              include 'ubahminta.php';
            }
            ...
            elseif ($_GET['page']=="detailbarang") {
              include 'detailbarang.php';
            }
			elseif ($_GET['page']=="detailbarang2") {
              include 'detailbarang2.php';
            }
